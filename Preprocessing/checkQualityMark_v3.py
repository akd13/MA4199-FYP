...
infileString = directory+prefix+'_sequence.txt'
infile = open(infileString)

triagefileString = directory+'triage_'+prefix+'_sequence.txt'
triagefile = open(triagefileString, 'w')

outfileString = directory+'adapTrim_'+prefix+'_sequence.txt'
